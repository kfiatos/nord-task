...
class getRouting_LoaderService extends App_KernelTestDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\Routing\AttributeRouteControllerLoader('test');

        $a->addLoader(new \Symfony\Component\Routing\Loader\XmlFileLoader($b, 'test'));
        $a->addLoader(new \Symfony\Component\Routing\Loader\YamlFileLoader($b, 'test'));
        $a->addLoader(new \Symfony\Component\Routing\Loader\PhpFileLoader($b, 'test'));
        $a->addLoader(new \Symfony\Component\Routing\Loader\GlobFileLoader($b, 'test'));
        $a->addLoader(new \Symfony\Component\Routing\Loader\DirectoryLoader($b, 'test'));
